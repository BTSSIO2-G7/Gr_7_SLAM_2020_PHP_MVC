...
$insert = $bdd->prepare('INSERT INTO lignefraisforfait(idVisiteur,mois,idFraisForfait,quantite) VALUES(:idVisiteur,:mois,:ETP,:etape)');
$insert->execute(array(
	'idVisiteur' => $_SESSION['idVisiteur'],
	'mois' => $_POST['mois'],
	'ETP' => 'ETP',
...
$insert = $bdd->prepare('INSERT INTO lignefraisforfait(idVisiteur,mois,idFraisForfait,quantite) VALUES(:idVisiteur,:mois,:KM,:kilo)');
$insert->execute(array(
	'idVisiteur' => $_SESSION['idVisiteur'],
	'mois' => $_POST['mois'],
	'KM' => 'KM',
...
$insert = $bdd->prepare('INSERT INTO lignefraisforfait(idVisiteur,mois,idFraisForfait,quantite) VALUES(:idVisiteur,:mois,:NUI,:nuitee)');
$insert->execute(array(
	'idVisiteur' => $_SESSION['idVisiteur'],
	'mois' => $_POST['mois'],
	'NUI' => 'NUI',
...
$insert = $bdd->prepare('INSERT INTO lignefraisforfait(idVisiteur,mois,idFraisForfait,quantite) VALUES(:idVisiteur,:mois,:REP,:repas)');
$insert->execute(array(
	'idVisiteur' => $_SESSION['idVisiteur'],
	'mois' => $_POST['mois'],
	'REP' => 'REP',
